<section id="feadback" class="padding ptb-xs-40 img_bg1">
			<div class="container">
								...
								<div class="row">
									...
									<div class="services-block col-lg-6 col-md-6 col-xs-12 mb-30">
										<div class="inner-box hvr-float">
											<div class="image">
												<img src="assets/images/amshacarcare/team/t_img2.jpg" alt="">

											</div>

											<!-- <div class="lower-box">
												<h5><a href="#">Auto Electrical</a></h5>
											</div> -->
									...
									<div class="services-block col-lg-6 col-md-6 mb-30">
										<div class="inner-box hvr-float">
											<div class="image">
												<img src="assets/images/amshacarcare/team/t_img5.jpg" alt="">

											</div>
											<!-- <div class="lower-box">
												<h5><a href="#">Wheel Allignment</a></h5>
											</div> -->
										</div>
									</div>
									...
									<!-- <div class="services-block col-lg-6 col-md-6 mb-30">
										<div class="inner-box hvr-float">
											<div class="image">
												<img src="assets/images/amshacarcare/team/t_img3.jpg" alt="">
									...
									<!-- <div class="services-block col-lg-6 col-md-6 mb-30">
										<div class="inner-box hvr-float">
											<div class="image">
												<img src="assets/images/amshacarcare/team/t_img4.jpg" alt="">
             ...
             $headers .= "From: amshaautomobiless@gmail.com";
		if(mail("amshaautomobiless@gmail.com","Book A Service", "<html><head><title>Amsha  Car Care</title></head><body><table class=\"table table-striped table-bordered\"><tr><td>Name:</td><td>$name</td></tr><tr><td>Email:</td><td>$email</td></tr><tr><td>Mobile:</td><td>$mobile</td></tr><tr><td>Message:</td><td>".$_POST["message"]."</td></tr></table></body></html>", $headers))
