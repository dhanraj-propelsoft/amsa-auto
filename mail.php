<section id="feadback" class="padding ptb-xs-40 img_bg1">
			<div class="container">
             ...
             $headers .= "From: trichycarcare@gmail.com";
		if(mail("trichycarcare@gmail.com","Book A Service", "<html><head><title>Trichy Car Care</title></head><body><table class=\"table table-striped table-bordered\"><tr><td>Name:</td><td>$name</td></tr><tr><td>Email:</td><td>$email</td></tr><tr><td>Mobile:</td><td>$mobile</td></tr><tr><td>Message:</td><td>".$_POST["message"]."</td></tr></table></body></html>", $headers))
